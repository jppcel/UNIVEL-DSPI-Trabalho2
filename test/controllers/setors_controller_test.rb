...
class SetorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setor" do
    assert_difference('Setor.count') do
      post setors_url, params: { setor: { letraSetor: @setor.letraSetor, nomeSetor: @setor.nomeSetor, ultimaSenha: @setor.ultimaSenha } }
    end
  ...
  test "should update setor" do
    patch setor_url(@setor), params: { setor: { letraSetor: @setor.letraSetor, nomeSetor: @setor.nomeSetor, ultimaSenha: @setor.ultimaSenha } }
